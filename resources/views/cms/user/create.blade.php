              ...
              <div class="x_panel">
                ...
                <div class="x_content">
                  <br />
                    ...
                    @if($fuc->create)
                    {!!Form::open(['data-parsley-validate','route'=>'user.store','method'=>'POST', 'class'=>'form-horizontal form-label-left'])!!}
                    @else
                    {!!Form::open(['data-parsley-validate','route'=> ['user.update', $fuc->id],'method'=>'PUT', 'class'=>'form-horizontal form-label-left'])!!}
                    @endif
                    ...
                    <div class="form-group">
                      <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                        <a href="/user/" type="submit" class="btn btn-primary">Cancelar</a>
